from PyQt5.QtWidgets import QApplication, QTabWidget, QPushButton, QAbstractButton
...
class Main(QBorderlessWindow):
	...
	def __init__(self):
		...
		self.navSocket.setCornerWidget(QPushButton(iconDir["ti-plus"]))
		self.navSocket.cornerWidget().clicked.connect(self.addNavTab)
	...
	def addNavTab(self):
		...
		self.navTabs[-1].changeDirectory()
